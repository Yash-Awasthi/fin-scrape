 ...
 *
 * Configuration on the Pantheon side:
 *   POLYMARKET_HOST=https://pantheon-trades.vercel.app/api/polymarket-proxy/clob
 *   POLYMARKET_GAMMA=https://pantheon-trades.vercel.app/api/polymarket-proxy/gamma
 *
 * Headers:
