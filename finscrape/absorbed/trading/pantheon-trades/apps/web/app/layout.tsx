...
export const metadata: Metadata = {
  ...
  metadataBase: new URL("https://pantheon-trades.vercel.app"),
  keywords: [
    "prediction markets",
    "Polymarket",
    "AI trading",
  ...
  authors: [{ name: "Pantheon Trades" }],
  creator: "Pantheon Trades",
  publisher: "Pantheon Trades",
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
  ...
  openGraph: {
    title: "Pantheon Trades — An eleven-agent AI council debates every trade",
    description:
    ...
    locale: "en_US",
    url: "https://pantheon-trades.vercel.app",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://pantheon-trades.vercel.app",
  },
  category: "technology",
};
...
const JSON_LD = {
  ...
  "@graph": [
    {
      "@type": "Organization",
      "@id": "https://pantheon-trades.vercel.app/#org",
      name: "Pantheon Trades",
      url: "https://pantheon-trades.vercel.app",
      logo: "https://pantheon-trades.vercel.app/icon.svg",
      sameAs: ["https://github.com/NAME0x0/Pantheon-Trades"],
    },
    {
      "@type": "WebSite",
      "@id": "https://pantheon-trades.vercel.app/#site",
      url: "https://pantheon-trades.vercel.app",
      name: "Pantheon Trades",
      publisher: { "@id": "https://pantheon-trades.vercel.app/#org" },
      inLanguage: "en-US",
    },
    {
      ...
      author: { "@id": "https://pantheon-trades.vercel.app/#org" },
