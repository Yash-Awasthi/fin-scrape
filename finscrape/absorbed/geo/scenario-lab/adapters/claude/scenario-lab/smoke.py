...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run the packaged Scenario Lab Claude smoke flow.")
    parser.add_argument("--work-dir")
    args = parser.parse_args()

    work_dir = Path(args.work_dir) if args.work_dir else Path(tempfile.mkdtemp(prefix="scenario-lab-claude-smoke-"))
